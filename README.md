...
# 数据库 监控
docker run -d --net town -e ME_CONFIG_MONGODB_SERVER=mongo -e ME_CONFIG_BASICAUTH_USERNAME="user" -e ME_CONFIG_BASICAUTH_PASSWORD="zsy8081" -p 8081:8081 mongo-express
```
